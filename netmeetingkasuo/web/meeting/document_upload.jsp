...
<div id="closeBtn" align="center" style="margin-top:20px;">
    <input type="button" id="docClose" name="cancel" value=" 关  闭 " onclick="documentUploadClose()"/>
    <input type="button" id="docPlay" name="docPlay" value=" 播  放 " onclick="documentPlay()" style="display:none;"/>
</div>
