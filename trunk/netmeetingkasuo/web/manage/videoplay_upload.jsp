...
<div id="btns" style="margin:20px;">
	<span id="spanButtonPlaceHolder" title="上传视频">&nbsp;</span>
</div>
...
<div id="closeBtn" align="center" style="margin-top:20px;">
    <input type="button" id="docClose" name="cancel" value=" 关  闭 " onclick="parent.videoDialogClose()"/>
</div>
...
<script type="text/javascript" src="../js/manage/videoplay_upload.js"></script>
</body>
</html>